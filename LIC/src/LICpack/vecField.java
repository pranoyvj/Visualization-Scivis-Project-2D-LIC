	...
	public void InitializeVecField( int x1, int y1, int width, int height) {
        ...
        for (int x = Initialx ; x < Initialx + Dimension; x++) {
            for (int y = Initialy; y < Initialy + Dimension; y++) {
            	...
            	double mapX5=mapRange(150,661,-10,10,x);
            	double mapY5=mapRange(100,611,-10,10,y);
            	...
            	xvec[x-Initialx][y-Initialy] = 0.2*mapX5*mapX5; //vecField 5
            	...
            	yvec[x-Initialx][y-Initialy] = 0.2*mapY5*mapY5; //vecField 5
